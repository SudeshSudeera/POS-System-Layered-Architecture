...
public class ProductMainFormController {
    ...
    public TableColumn colPDShowMore;
    ...
    public void initialize() throws SQLException, ClassNotFoundException {
        ...
        colPDShowMore.setCellValueFactory(new PropertyValueFactory<>("showPrice"));
    ...
    public void btnNewBatchOnAction(ActionEvent actionEvent) throws IOException, WriterException {
    ...
    private void loadAllProducts(String searchText) throws SQLException, ClassNotFoundException {
        ...
        for (ProductDto dto : bo.findAllProducts()) {
            Button showMore = new Button("Shore More");
    ...
    private void loadBatchData(int code) throws SQLException, ClassNotFoundException {
        ...
        for (ProductDetailDto p : detailBo.findAllProductDetails(code)) {
            ...
            ProductDetailTm tm = new ProductDetailTm(
                    p.getCode(),p.getQtyOnHand(),
                    p.getSellingPrice(),p.getBuyingPrice(),
                    p.isDiscountAvailability(),p.getShowPrice(),btn
            );
            obList.add(tm);
        }
